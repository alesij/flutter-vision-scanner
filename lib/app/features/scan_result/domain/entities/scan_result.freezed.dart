...
class TextResult implements ScanResult {
  const TextResult({required this.rawText, required this.processedImagePath});
...
/// Create a copy of ScanResult
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? rawText = null,Object? processedImagePath = null,}) {
