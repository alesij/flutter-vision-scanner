...
switch (_that) {
case Left() when left != null:
return left(_that.left);case Right() when right != null:
...
switch (_that) {
case Left():
return left(_that.left);case Right():
return right(_that.right);case _:
  throw StateError('Unexpected subclass');
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Left<L, R>&&const DeepCollectionEquality().equals(other.left, left));
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Right<L, R>&&const DeepCollectionEquality().equals(other.right, right));
}
